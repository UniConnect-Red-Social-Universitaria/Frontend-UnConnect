...
export default function ContactScreen() {
  ...
  const [sendingSolicitudTo, setSendingSolicitudTo] = useState<string | null>(
    null,
  );
    ...
    <View style={styles.card}>
      <View style={styles.infoContainer}>
        ...
        <Text style={styles.email}>
          {item.correo || "Correo no disponible"}
        </Text>
      </View>
      <Pressable
        style={({ pressed }) => [
    ...
    <View style={principalStyles.container}>
      <View style={principalStyles.header}>
        ...
        <View style={principalStyles.headerRight}>
          <Pressable
            style={principalStyles.logoutButton}
      ...
      <View style={principalStyles.mainContent}>
        ...
        {loading ? (
          ...
          <FlatList<Contacto>
            ...
            ListHeaderComponent={
              <View style={styles.screenHeader}>
                <View style={styles.solicitudesSection}>
                  <Text style={styles.solicitudesTitle}>
                      ...
                      return (
                        ...
                        >
                          <View style={styles.solicitudInfo}>
                            ...
                            <Text style={styles.solicitudCorreo}>
                              {solicitud.correo}
                            </Text>
                          </View>
                          ...
                          <View style={styles.solicitudActions}>
                            ...
                            <Pressable
                              ...
                              disabled={estaProcesando}
                            >
                              <Text style={styles.rechazarButtonText}>
                                Rechazar
                              </Text>
                            </Pressable>
                          </View>
            ...
            ListEmptyComponent={
              <Text style={styles.centerText}>
                No tienes contactos agregados aun.
              </Text>
            }
          />
        )}
