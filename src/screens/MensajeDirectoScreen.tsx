...
export default function MensajeDirectoScreen() {
  ...
  const renderItem = ({ item }: { item: any }) => (
    <View style={[styles.msgBubble, item.emisorId === userId ? styles.msgBubbleYo : styles.msgBubbleOtro]}>
      ...
      <View style={styles.chatWrapper}>
        ...
        <View style={styles.footer}>
          ...
          <View style={styles.inputRow}>
            ...
            <TouchableOpacity style={styles.sendBtn} onPress={handleEnviarMensaje} disabled={enviando}>
