...
import { localStyles } from '../styles/SolicitudesScreen.styles';
...
export default function SolicitudesScreen({ navigation }: Props) {
		...
		return (
			<View style={localStyles.card}>
				...
				<View style={localStyles.actionsRow}>
					<PrimaryButton
						style={[localStyles.acceptButton, estaProcesando && { opacity: 0.45 }]}
					...
					<PrimaryButton
						style={[localStyles.rejectButton, estaProcesando && { opacity: 0.45 }]}
						disabled={estaProcesando}
						onPress={() => {
	...
	return (
		<Screen style={principalStyles.container}>
