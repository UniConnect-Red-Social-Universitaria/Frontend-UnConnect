	...
	const publicarEvento = async () => {
		...
		if (!fechaEventoInput.trim()) {
			setMensajePublicacion(
				'Falta la hora. Debes seleccionar una fecha y hora completa para el evento.'
			);
			return;
		}
			...
			<Pressable style={styles.modalOverlay} onPress={() => Keyboard.dismiss()}>
				...
				>
						...
						<input
							...
							value={
								formulario.fechaEventoInput
									? new Date(formulario.fechaEventoInput).toISOString().slice(0, 16)
									: ''
							}
					...
					<PrimaryButton
						...
						disabled={publicando}
						style={[styles.button, publicando ? styles.buttonDisabled : null]}
					>
